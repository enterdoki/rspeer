...
@ScriptMeta(name = "NMZ", desc = "Efficient NMZ Training", developer = "Enterdoki", version = 1.1, category = ScriptCategory.COMBAT)
public class NMZ extends Script implements RenderListener, ChatMessageListener {
    ...
    public int loop() {
        ...
        if (Local.getFloorLevel() == 3) {
            ...
            } else if (Inventory.contains(item -> item.getName().startsWith("Absorption")) && currentAbsorption() < 250) {
